...
frame = imread('Motic4.bmp'); 
J = (.2989*frame(:,:,1) + .5870*frame(:,:,2) + .1140*frame(:,:,3));

%Rotate image for aligment
% J = imrotate(I,0.00,'bilinear');
%Save image
Folder = 'C:\Users\Bergues\Dropbox\Matlab softwares\Retícula óptica';
File   = 'Motic4_gray.bmp';
...
Ic_ref = imcrop(J, [1 950 419 49]);%[xmin ymin width height]%image cut
...
dist1 = b_d3x(3) - b_d3x(2);
dist2 = b_d3x(4) - b_d3x(3);
...
dist1 = b_d4x(2) - b_d4x(1);
dist2 = b_d4x(3) - b_d4x(2);
...
dist1 = b_d7x(3) - b_d7x(2);
dist2 = b_d7x(4) - b_d7x(3);
